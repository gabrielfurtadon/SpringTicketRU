...
import br.com.gerencianet.gnsdk.APIRequest;
import br.com.gerencianet.gnsdk.Config;
import br.com.gerencianet.gnsdk.Endpoints;
...
public class EndpointsTest {
    ...
    public void shouldGenerateRequestWithMapBodySuccessfuly() throws Exception {
        ...
        endpoints = new Endpoints(config, apiRequester);
        HashMap<String, Object> response = (HashMap<String, Object>) endpoints.call("charge",
    ...
    public void shouldForwarWithQueryString() throws Exception {
        ...
        try {
            ...
            Assert.assertTrue(route.equals("/v1/charge?token=45646546894621&id=1")
                    || route.equals("/v1/charge?id=1&token=45646546894621"));
        }
    }
}